...
import iitdh.sonusourav.InstiMessage.core.logout.LogoutContract;
import iitdh.sonusourav.InstiMessage.core.logout.LogoutPresenter;
import iitdh.sonusourav.InstiMessage.ui.adapters.UserListingPagerAdapter;
...
public class UserListingActivity extends AppCompatActivity implements LogoutContract.View {
    ...
    public void onBackPressed()
    {
        ...
        else { Toast.makeText(getBaseContext(), "Press once more in order to exit", Toast.LENGTH_SHORT).show();
        }
